...
public class WorkRecord {
	...
	public WorkRecord(int u_id, int d_id, String w_in, String w_out, int w_time, String w_status, String w_reason) {
		super();
		this.u_id = u_id;
		this.d_id = d_id;
		this.w_in = w_in;
	...
	public String toString() {
		return "WorkRecord [u_id=" + u_id + ", d_id=" + d_id + ", w_in=" + w_in + ", w_out=" + w_out + ", w_time="
				+ w_time + ", w_status=" + w_status + ", w_reason=" + w_reason + "]";
	}

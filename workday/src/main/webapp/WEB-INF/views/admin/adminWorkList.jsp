...
<script>
	...
	$(function () {
		...
		adminWorkListAjaxfn(1);	//현재 page =1 ->기본시작, 접근하는 순간 시작
	})

	// 리스트 Ajax 처리
	function adminWorkListAjaxfn(cPage) {
		$.ajax({
			url: "<c:url value="/"/>admin/adminworkListAjax",
			data: {
				"cPage": cPage,

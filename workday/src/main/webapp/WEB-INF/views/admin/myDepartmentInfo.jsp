...
<%@ include file="../common/head.jsp"%>
	...
	$(function () {
		...
		myDepartmentInfojax(1);	//현재 page =1 ->기본시작, 접근하는 순간 시작
	})

	// 리스트 Ajax 처리
	function myDepartmentInfojax(cPage) {
		$.ajax({
			url: "<c:url value="/"/>admin/myDepartmentInfoAjax",
			data: {
				"cPage": cPage,
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
            ...
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
									...
									<div id="myDepartmentInfojax"></div>

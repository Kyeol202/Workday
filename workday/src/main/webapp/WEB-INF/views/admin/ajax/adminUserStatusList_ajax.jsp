			...
			<tbody>
				<c:forEach var="statusAllList" items="${statusAllList }">
					<tr role="row">
						...
						admin/adminStatusRecordSelectOne?apv_id=${statusAllList.apv_id }'">${statusAllList.u_id }</td>
						...
						<td onclick="javascript:location.href='<c:url value="/"/>admin/adminStatusRecordSelectOne?apv_id=${statusAllList.apv_id }'">${statusAllList.apv_start }</td>

...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
        ...
        <div class="AXdemoPageContent">
            ...
            <div id="grid0">
                <h2>타이틀 미정</h2>
                <div id="AXGridTarget" style="height:300px;">
                <div class="AXGrid" id="AXGridTarget_AX_grid" style="overflow:hidden;height:300px;">
                	<div class="AXgridScrollBody" id="AXGridTarget_AX_gridScrollBody" style="z-index: 2; height: 267px;">

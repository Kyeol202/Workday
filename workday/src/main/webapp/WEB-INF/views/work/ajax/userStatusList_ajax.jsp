		...
		<div class="dataTables_paginate paging_simple_numbers">
			<ul class="pagination">
				<c:if test="${boardPager.curBlock > 1 }">
					<li class="paginate_button previous disabled"><a href="javascript:statusListAjaxfn(${boardPager.prevPage})">Previous</a></li>
				</c:if>
				...
				<c:if test="${boardPager.curBlock <= boardPager.totBlock }">
					<li class="paginate_button next" id="example1_next"><a href="javascript:statusListAjaxfn(${boardPager.nextPage})">Next</a></li>
				</c:if>
			</ul>
		</div>
	</div>
